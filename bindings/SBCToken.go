...
func (_Token *TokenTransactor) Burn(opts *bind.TransactOpts, _from common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "burn", _from, _amount)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address _from, uint256 _amount) returns()
func (_Token *TokenSession) Burn(_from common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Burn(&_Token.TransactOpts, _from, _amount)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address _from, uint256 _amount) returns()
func (_Token *TokenTransactorSession) Burn(_from common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Burn(&_Token.TransactOpts, _from, _amount)
}
...
func (_Token *TokenTransactor) ClaimTokens(opts *bind.TransactOpts, _token common.Address, _to common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "claimTokens", _token, _to)
}

// ClaimTokens is a paid mutator transaction binding the contract method 0x69ffa08a.
//
// Solidity: function claimTokens(address _token, address _to) returns()
func (_Token *TokenSession) ClaimTokens(_token common.Address, _to common.Address) (*types.Transaction, error) {
	return _Token.Contract.ClaimTokens(&_Token.TransactOpts, _token, _to)
}

// ClaimTokens is a paid mutator transaction binding the contract method 0x69ffa08a.
//
// Solidity: function claimTokens(address _token, address _to) returns()
func (_Token *TokenTransactorSession) ClaimTokens(_token common.Address, _to common.Address) (*types.Transaction, error) {
	return _Token.Contract.ClaimTokens(&_Token.TransactOpts, _token, _to)
}
...
func (_Token *TokenTransactor) SetMinter(opts *bind.TransactOpts, minter common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "setMinter", minter)
}

// SetMinter is a paid mutator transaction binding the contract method 0xfca3b5aa.
//
// Solidity: function setMinter(address minter) returns()
func (_Token *TokenSession) SetMinter(minter common.Address) (*types.Transaction, error) {
	return _Token.Contract.SetMinter(&_Token.TransactOpts, minter)
}

// SetMinter is a paid mutator transaction binding the contract method 0xfca3b5aa.
//
// Solidity: function setMinter(address minter) returns()
func (_Token *TokenTransactorSession) SetMinter(minter common.Address) (*types.Transaction, error) {
	return _Token.Contract.SetMinter(&_Token.TransactOpts, minter)
}
...
func (_Token *TokenTransactor) TransferAndCall(opts *bind.TransactOpts, _to common.Address, _amount *big.Int, _data []byte) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "transferAndCall", _to, _amount, _data)
}

// TransferAndCall is a paid mutator transaction binding the contract method 0x4000aea0.
//
// Solidity: function transferAndCall(address _to, uint256 _amount, bytes _data) returns()
func (_Token *TokenSession) TransferAndCall(_to common.Address, _amount *big.Int, _data []byte) (*types.Transaction, error) {
	return _Token.Contract.TransferAndCall(&_Token.TransactOpts, _to, _amount, _data)
}

// TransferAndCall is a paid mutator transaction binding the contract method 0x4000aea0.
//
// Solidity: function transferAndCall(address _to, uint256 _amount, bytes _data) returns()
func (_Token *TokenTransactorSession) TransferAndCall(_to common.Address, _amount *big.Int, _data []byte) (*types.Transaction, error) {
	return _Token.Contract.TransferAndCall(&_Token.TransactOpts, _to, _amount, _data)
}
